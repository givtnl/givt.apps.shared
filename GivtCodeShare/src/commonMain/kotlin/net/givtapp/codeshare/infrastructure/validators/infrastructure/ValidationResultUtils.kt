 ...
 */
operator fun <T> ValidationResult<T>.contains(error: IValidationError): Boolean =
 ...
 */
inline fun <reified T> ValidationResult<T>.assertContains(error: IValidationError) {
