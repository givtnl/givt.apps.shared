...
sealed class ValidationResult<T> {
     ...
     */
    data class Invalid<T> internal constructor(val errors: Collection<IValidationError>) : ValidationResult<T>() {
 ...
 */
@Suppress("FunctionName")
fun <T> Invalid(errors: List<IValidationError>): ValidationResult.Invalid<T> = ValidationResult.Invalid(errors)
 ...
 */
@Suppress("FunctionName")
fun <T> Invalid(vararg errors: IValidationError): ValidationResult.Invalid<T> = ValidationResult.Invalid(errors.toList())